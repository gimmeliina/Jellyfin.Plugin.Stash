namespace Stash
{
    public static class Consts
    {
        ...
        public const string SceneSearchQuery = @"query{{findScenes({0}){{scenes{{id,title,date,paths{{screenshot}}groups{{group{{front_image_path}}}}}}}}}}";

        public const string SceneQuery = @"query{{findScene(id:{0}){{id,title,details,date,paths{{screenshot}}groups{{group{{front_image_path,director}}}}studio{{name,parent_studio{{name}}}}tags{{name}}performers{{id,name,disambiguation,image_path}}}}}}";
    }
}
